...
plt.title('ViT, ImageNet', fontsize=16)
...
json_file_path = base_dir+'performance_scripts/perf_log/kernel_standard/model_tiled_mlpmixer/log_True_compress4/maserati_1971930.1705079129681074821.pt.trace.json'
memory_data1 = extract_memory_data(json_file_path)

json_file_path = base_dir+'performance_scripts/perf_log/kernel_tiled/model_tiled_mlpmixer/log_True_compress4/maserati_1971996.1705079160147108123.pt.trace.json'
memory_data2= extract_memory_data(json_file_path)

json_file_path = base_dir+'performance_scripts/perf_log/kernel_tiled/model_tiled_mlpmixer/log_True_compress8/maserati_1972055.1705079207382481789.pt.trace.json'
memory_data3= extract_memory_data(json_file_path)
...
plt.title('MLPMixer', fontsize=16)
