...
def main(arguments):
    ...
    parser.add_argument('--data_dir', help='directory to save data to', type=str, default='/s/lovelace/c/nobackup/iray/mgorb/glue_data')
    parser.add_argument('--tasks', help='tasks to download data for as a comma separated string',
                        type=str, default='all')
    parser.add_argument('--path_to_mrpc', help='path to directory containing extracted MRPC data, msr_paraphrase_train.txt and msr_paraphrase_text.txt',
                        type=str, default='/s/lovelace/c/nobackup/iray/mgorb/mrpc_data/MRPC')
...
if __name__ == '__main__':
    #data_dir=/s/lovelace/c/nobackup/iray/mgorb/glue_data
