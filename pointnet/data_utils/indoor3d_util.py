...
BASE_DIR = '/s/lovelace/c/nobackup/iray/mgorb/pointnet/'#os.path.dirname(os.path.abspath(__file__))
ROOT_DIR = os.path.dirname(BASE_DIR)
sys.path.append(BASE_DIR)

DATA_PATH = os.path.join(ROOT_DIR, 's3dis', 'Stanford3dDataset_v1.2_Aligned_Version')
print(DATA_PATH)
#sys.exit()
