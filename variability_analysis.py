        ...
        for m1,m2 in zip(model1.named_modules(), model2.named_modules()):
            ...
            if isinstance(mod1, SubnetConvEdgePopup) or isinstance(mod1,SubnetConvBiprop):
                ...
                if isinstance(mod1,SubnetConvBiprop):
                    mask1=GetQuantnet_binary.apply(mod1.clamped_scores, mod1.weight, mod1.prune_rate).nonzero()
                    mask2=GetQuantnet_binary.apply(mod2.clamped_scores, mod2.weight, mod2.prune_rate).nonzero()
