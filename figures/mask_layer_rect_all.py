...
ax =lineplot(data=dfm2, x='cols', y="mean", marker="8",markersize=7,label=f'Edge-Popup, {int(100*(1-prune_rate))}% weights pruned')
ax.fill_between(dfm2['cols'], dfm2['min'], dfm2['max'], alpha=0.2)
ax =lineplot(data=dfm3, x='cols', y="mean", marker="v",markersize=7,label=f'Biprop, {int(100*(1-prune_rate))}% weights pruned')
