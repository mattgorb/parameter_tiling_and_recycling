...
#SBATCH --gres=gpu:nvidia_a100_3g.39gb:2              # Request 1 GPU (A100 40GB)
#SBATCH --time=5-0:00:00 				 #  wall time
#SBATCH --nodelist=peregrine1
...
python -u main_parallel_peregrine.py --config configs/imagenet/resnet50-biprop-tiled-params-randtile.yaml --gpu=0 --multigpu=0 --batch-size=1024
