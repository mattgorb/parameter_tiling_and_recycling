...
python -u ../main_parallel_kestrel.py --config ../configs/imagenet/resnet18-tiled-full-rerandtile.yaml --gpu=0 --multigpu=0,1,2 --batch-size=128  --alpha_param='scores' --resume /s/babbage/b/nobackup/nblancha/public-datasets/subnetworks/runs/resnet18-tiled-full-rerandtile/tiled/prune_rate=0.0/0/checkpoints/model_best.pth