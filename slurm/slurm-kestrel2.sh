...
python -u ../main_parallel_kestrel.py --config ../configs/imagenet/resnet34-tiled-full-rerandtile.yaml --gpu=0 --multigpu=0,1,2 --batch-size=128 #--resume /s/babbage/b/nobackup/nblancha/public-datasets/subnetworks/runs/resnet34-tiled-full-rerandtile/biprop/prune_rate=-1/0/checkpoints/model_best.pth